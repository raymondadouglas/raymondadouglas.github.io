...
[**Disempowerment Patterns in real-world LLM usage**](https://arxiv.org/abs/2601.19062) ([*anthropic blog*](https://www.anthropic.com/research/disempowerment-patterns)) — a paper analysing how people delegate to AI assistants, potentially in ways that are unhealthy or that they regret.
