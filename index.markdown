---
layout: research
title: "Raymond Douglas"
description: "Researcher thinking about how advanced AIs might fit into society — what they might look like, what challenges we'll need to grapple with, and what we should even be aiming for."
image: /images/research-profile.jpeg
redirect_from:
  - /research/
---
...
<div class="card headercard">
    ...
    <div class="headertext">
        ...
        <p class="affiliation">
            <a href="mailto:raymondadouglas@gmail.com" title="concerned citizen">raymondadouglas</a><span class="at">@</span><a href="mailto:raymondadouglas@gmail.com" title="concerned citizen">gmail.com</a>
            <a href="mailto:raymond@acsresearch.org" title="senior researcher">raymond</a><span class="at">@</span><a class="dom" href="https://acsresearch.org/" title="ACS Research">acsresearch.org</a>
            <a href="mailto:ray@cs.toronto.edu" title="research affiliate">ray</a><span class="at">@</span><a class="dom" href="https://www.cs.toronto.edu/" title="University of Toronto, Department of Computer Science">cs.toronto.edu</a>
        </p>
    </div>
    <div class="social-icons">
        <a href="https://scholar.google.com/citations?user=RcAqOJQAAAAJ&hl=en" title="Google Scholar"><svg viewBox="0 0 512 512" role="img" aria-label="Google Scholar"><path d="M256 411.12 0 202.667 256 0l256 202.667-256 208.453zm149.6-83.4-149.6 121.75L106.4 327.7c-14.7 15.8-24.05 36.9-24.05 60.2 0 63.6 77.7 115.1 173.65 115.1 95.9 0 173.6-51.5 173.6-115.1 0-23.3-9.3-44.4-24-60.2z"/></svg></a>
        <a href="https://legacymode.substack.com/" title="Substack"><svg viewBox="0 0 24 24" role="img" aria-label="Substack"><path d="M22.539 8.242H1.46V5.406h21.08v2.836ZM1.46 10.812V24L12 18.11 22.54 24V10.812H1.46ZM22.54 0H1.46v2.836h21.08V0Z"/></svg></a>
        <a href="https://x.com/raymondadouglas" title="Twitter"><svg viewBox="0 0 24 24" role="img" aria-label="Twitter"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg></a>
        <a href="https://www.lesswrong.com/users/raymond-douglas" title="LessWrong"><svg viewBox="0 0 24 24" role="img" aria-label="LessWrong"><text x="12" y="17" text-anchor="middle" font-family="Georgia, serif" font-weight="bold" font-size="14" fill="currentColor">LW</text></svg></a>
        <a href="https://claude.ai/share/d89a0b82-f4cc-49a1-a41f-82b6786ba7a8" title="Claude"><svg viewBox="0 0 24 24" role="img" aria-label="Claude"><path d="m4.7144 15.9555 4.7174-2.6471.079-.2307-.079-.1275h-.2307l-.7893-.0486-2.6956-.0729-2.3375-.0971-2.2646-.1214-.5707-.1215-.5343-.7042.0546-.3522.4797-.3218.686.0608 1.5179.1032 2.2767.1578 1.6514.0972 2.4468.255h.3886l.0546-.1579-.1336-.0971-